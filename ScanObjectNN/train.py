...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_gn', action='store_true', help='Use group norm? (default: False)')
    ...
    if not args.no_bn and not args.use_gn:
        params_string = "__1_"
    else:
        params_string = "__0_"
    ...
    if args.conv_type == "mcconv":
        ...
        if batch_size < 4:
            learning_rate = 0.001
        layer_factory = pccnn_lib.pc.layers.PointConvFactory(16, not args.no_const_var, const_var_value, 
            not args.no_bn, args.use_gn, 32)
